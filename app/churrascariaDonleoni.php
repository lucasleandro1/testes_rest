...
include 'Product.php';
include("conexao.php");
  $q = "SELECT * FROM abs_food WHERE abs_rest_id = 3";
...
if (isset($_GET['id'])) {
  ...
  $productInfo = $products[$id-7];
  $product = new Product;
  $product->setId($productInfo['id3']);
  $product->setName($productInfo['name3']);
  $product->setPrice($productInfo['price3']);
  $product->setQuantity($productInfo['quantity3']);
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" style="height: 225px; width: 100%; display: block;" src="./Components/<?php echo $dado['name3']; ?>.jpg" data-holder-rendered="true">
                <div class="card-body">
                <h5 class="card-title"><?php echo $dado['name3']; ?></h5>
                <p class="card-subtitle mb-2 text-muted"><?php echo $dado['cat3']; ?></p>
                <p class="card-text"><?php echo $dado['desc3']; ?></p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class=" btn btn-sm btn-outline-secondary">
                        <a href="?id=<?php echo $dado['id3']; ?>">Adicionar</a>
                      </button>
                      </div>
                    <small class="text-muted">R$ <?php echo $dado['price3']; ?></small>
                  </div>
                </div>
              </div>
            </div>
